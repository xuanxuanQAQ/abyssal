...
const BUILTIN_PRICING: Record<string, ModelPricing> = {
  ...
  'doubao-seed-2-0-pro':    { inputPer1M: 0.47,  outputPer1M: 2.37  },
  'doubao-seed-2-0-lite':   { inputPer1M: 0.09,  outputPer1M: 0.53  },
  'doubao-seed-2-0-mini':   { inputPer1M: 0.03,  outputPer1M: 0.30  },
  'doubao-seed-1-8':        { inputPer1M: 0.25,  outputPer1M: 2.00  },
  'kimi-k2.5':              { inputPer1M: 0.56,  outputPer1M: 2.92  },
  'kimi-k2-0905':           { inputPer1M: 0.56,  outputPer1M: 2.22  },
  'kimi-k2-0711':           { inputPer1M: 0.56,  outputPer1M: 2.22  },
  'kimi-k2-turbo':          { inputPer1M: 1.11,  outputPer1M: 8.06  },
  'kimi-k2-thinking':       { inputPer1M: 0.56,  outputPer1M: 2.22  },
